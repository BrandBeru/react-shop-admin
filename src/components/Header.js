                ...
                <div className="flex items-center gap-3">
                  <div className="flex-shrink-0">
                    <div className="flex gap-3">
                      <img className="h-8 w-8" src="https://raw.githubusercontent.com/BrandBeru/BrandBeru.github.io/09ad12cddfbf88138ef90fb55f7a3e8b967fe182/icon/icon.svg" alt="Workflow" />
                    ...
                    <Menu as="div" className="ml-3 relative">
                      ...
                      >
                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                          <button onClick={() => logout()} className="w-full block px-4 py-2 text-sm text-red-700">
                            Logout
                          </button>
                        </Menu.Items>
                      </Transition>
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                ...
                <div className="mt-3 px-2 space-y-1">
                  <Disclosure.Button onClick={() => logout()} as="a" className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-red-700">
                    Logout
                  </Disclosure.Button>
                </div>
              </div>
